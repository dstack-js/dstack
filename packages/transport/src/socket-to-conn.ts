...
const log = logger('dstack:transport:socket')
 ...
 */
export function toMultiaddrConnection(
  socket: WebRTCPeer,
  options: ToMultiaddrConnectionOptions
): MultiaddrConnection {
  ...
  const maConn: MultiaddrConnection = {
    ...
    source:
      options.signal != null ? abortableSource(source, options.signal) : source,
